...
('Horizon Zero Dawn', 'LA TIERRA YA NO NOS PERTENECE

Vive la misión legendaria de Aloy para desvelar los secretos de un mundo dominado por máquinas letales.

La joven cazadora, una paria, lucha por revelar su pasado, descubrir su destino y detener una amenaza catastrófica para el futuro.

Desata devastadores ataques contra máquinas únicas y tribus rivales mientras exploras un mundo abierto repleto de vida salvaje y peligros.', '2020-08-07', 'Guerrilla Games', 'PlayStation'),
...
('Resident Evil 4 Remake', 'Sobrevivir es solo el principio.
